...
export const StartupPlans = () => (
  <section className="py-24 bg-neutral-100/50 min-h-screen flex flex-col items-center gap-12 px-6 font-dmSans">
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
        ...
        <div className="bg-white rounded-xl p-8 border border-neutral-200 relative h-fit overflow-hidden group">
        ...
        <div className="bg-neutral-950 rounded-xl p-10 w-full text-white shadow-2xl relative overflow-hidden">
