...
export const ProductPacks = () => (
  <section className="py-24 px-6 bg-yellow-50 text-black min-h-screen">
    <div className="max-w-4xl mx-auto ">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-semibold tracking-tight mb-4">
          Flexible plans for every business
        </h1>
        <p className="text-neutral-500 text-pretty max-w-lg leading-relaxed mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Demo Card */}
        <div className="bg-amber-300 border border-neutral-100 rounded-4xl p-10 flex flex-col shadow-sm space-y-6">
        ...
        {/* Full Pack Card */}
        <div className="bg-neutral-900 text-white rounded-4xl p-10 flex flex-col shadow-2xl ring-1 ring-white/10 space-y-6">
          <div className="">
            <h3 className="text-2xl font-semibold mb-2 flex items-center gap-2">
