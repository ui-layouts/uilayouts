...
export const GrowthBusiness = () => {
  ...
  const id = useId()
  return (
    <section className="py-24 bg-slate-100 font-dmSans text-black min-h-screen">
      <div className="max-w-6xl mx-auto md:px-0 px-6 text-center">
        ...
        <div className="flex items-center justify-center gap-4 mb-16 bg-lime-100 border border-lime-400 font-semibold w-fit p-3 mx-auto rounded-full">
          <span
            className={cn(
