  ...
  return (
    <section className=" min-h-screen relative pb-10 bg-[url('http://localhost:3000/shadow13.png')] bg-cover bg-center bg-no-repeat">
      ...
      <header className="flex gap-2 z-50 text-neutral-900 backdrop-blur-lg border border-gray-200/80 bg-white top-2 rounded-lg max-w-4xl items-center justify-between mx-auto px-3 p-2 sticky">
        ...
        <button className="text-lg h-10 px-4 rounded-lg text-white flex items-center gap-2 bg-neutral-800 relative before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-2 before:bg-linear-to-t before:from-neutral-800 before:to-neutral-500 before:rounded-t-lg  transition-all group">
          Log In
        </button>
      </header>
      ...
      <div className="gap-2 max-w-6xl mx-auto grid grid-cols-3">
        <figure className="p-2 bg-white rounded-lg">
          <div className="bg-linear-to-t to-neutral-100 from-neutral-50 rounded-lg p-4 h-80 flex flex-col overflow-hidden relative">
            ...
            <div className="flex gap-2 shrink-0 items-center bg-white justify-between w-100 p-2 top-6 rounded-xl relative -left-36 rotate-6">
            ...
            <div className="flex gap-4 shrink-0 items-center bg-white w-100 p-2 top-6 rounded-xl relative -right-20 -rotate-6">
              <button className="bg-blue-500 p-2 px-4 shadow-blue-600 shadow-lg rounded-lg text-white">
                Plan Now
              </button>
        ...
        <figure className="p-2 bg-white rounded-lg">
          <div className="bg-linear-to-t to-neutral-100 from-neutral-50 rounded-lg p-2 h-80 flex flex-col relative">
            <div className="flex justify-between absolute top-0 left-0 w-full items-end px-4 h-[75%]">
              <div className="h-[50%] w-12 bg-linear-to-b from-gray-300 to-gray-100 rounded-lg"></div>
              <div className="h-[60%] w-12 bg-linear-to-b from-gray-300 to-gray-100 rounded-lg"></div>
              <div className="h-[90%] w-12 bg-linear-to-b from-blue-500 to-gray-100 rounded-lg"></div>
              <div className="h-[80%] w-12 bg-linear-to-b from-gray-300 to-gray-100 rounded-lg"></div>
              <div className="h-[65%] w-12 bg-linear-to-b from-gray-300 to-gray-100 rounded-lg"></div>
            </div>
            <ProgressiveBlur
