...
- [`packages/blocks/src/hero-section/hero-share-app.tsx`](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/hero-section/hero-share-app.tsx) — the canonical block source and the exact effect composition
...
Core palette: `bg-red-50`, `text-neutral-900`, `bg-neutral-800`, `border-neutral-900`, `bg-red-500`. Keep the same canvas, text, border, and accent roles; do not add unrelated colors.
...
[Open the exact implementation (lines 126–132)](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/hero-section/hero-share-app.tsx#L126-L132) — The gradient’s focal point, stops, and layer position establish the block’s backdrop.

### 2. Depth and glow treatment

[Open the exact implementation (lines 187–193)](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/hero-section/hero-share-app.tsx#L187-L193) — These exact shadows and blur layers distinguish foreground from atmosphere.

### 3. Overlapping transformed composition

[Open the exact implementation (lines 241–247)](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/hero-section/hero-share-app.tsx#L241-L247) — Rotation and offset create the intentionally physical, layered arrangement.
<!-- source-audit:end -->
