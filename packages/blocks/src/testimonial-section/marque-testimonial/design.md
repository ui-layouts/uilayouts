...
- [`packages/blocks/src/testimonial-section/marque-testimonial.tsx`](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/testimonial-section/marque-testimonial.tsx) — the canonical block source and the exact effect composition
...
Core palette: `from-zinc-50`, `to-white`, `text-zinc-900`, `text-zinc-600`, `text-yellow-400`. Keep the same canvas, text, border, and accent roles; do not add unrelated colors.
...
[Open the exact implementation (lines 61–72)](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/testimonial-section/marque-testimonial.tsx#L61-L72) — The motion configuration controls the effect’s timing, position, and interaction response.

### 2. Motion-driven behavior

[Open the exact implementation (lines 113–124)](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/testimonial-section/marque-testimonial.tsx#L113-L124) — The motion configuration controls the effect’s timing, position, and interaction response.

### 3. Motion-driven behavior

[Open the exact implementation (lines 165–171)](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/testimonial-section/marque-testimonial.tsx#L165-L171) — The motion configuration controls the effect’s timing, position, and interaction response.
<!-- source-audit:end -->
