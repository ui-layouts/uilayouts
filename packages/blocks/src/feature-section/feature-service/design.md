...
- [`packages/blocks/src/feature-section/feature-service.tsx`](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/feature-section/feature-service.tsx) — the canonical block source and the exact effect composition
...
Core palette: `bg-slate-50`, `border-slate-200`, `text-slate-500`, `text-slate-900`, `bg-blue-600`, `bg-blue-700`, `shadow-blue-100`. Keep the same canvas, text, border, and accent roles; do not add unrelated colors.
...
[Open the exact implementation (lines 24–30)](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/feature-section/feature-service.tsx#L24-L30) — These exact shadows and blur layers distinguish foreground from atmosphere.
<!-- source-audit:end -->
