...
- [`packages/blocks/src/team-section/team-synth.tsx`](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/team-section/team-synth.tsx) — the canonical block source and the exact effect composition
...
Core palette: `bg-neutral-950`, `text-white`, `bg-[linear-gradient(to_right,#292929_1px,transparent_1px),linear-gradient(to_bottom,#292929_1px,transparent_1px)]`, `bg-[radial-gradient(125%_125%_at_50%_10%,rgba(255,255,255,0)_40%,rgba(102,51,238,1)_100%)]`, `from-cyan-400`, `to-blue-600`, `bg-violet-950`. Keep the same canvas, text, border, and accent roles; do not add unrelated colors.
...
[Open the exact implementation (lines 35–42)](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/team-section/team-synth.tsx#L35-L42) — The gradient’s focal point, stops, and layer position establish the block’s backdrop.

### 2. Source-specific visual behavior

[Open the exact implementation (lines 43–53)](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/team-section/team-synth.tsx#L43-L53) — This source fragment contains a high-signal visual or interaction decision unique to the block.

### 3. Low-opacity icon pattern

[Open the exact implementation (lines 58–74)](https://github.com/ui-layouts/uilayouts/blob/main/packages/blocks/src/team-section/team-synth.tsx#L58-L74) — Repeated icons at low opacity create a branded texture without competing with foreground content.
<!-- source-audit:end -->
