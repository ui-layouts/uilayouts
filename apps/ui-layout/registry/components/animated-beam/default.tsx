...
export default function AnimatedBeamDefault() {
  ...
  return (
    <div
      className='relative flex w-full max-w-[500px] mx-auto items-center justify-center overflow-hidden rounded-lg border bg-muted lg:p-10 sm:p-4 p-2 md:shadow-xl'
      ref={containerRef}
    >
