...
export default function index() {
  ...
  return (
    <div
      className='relative flex h-full w-full max-w-[32rem] mx-auto items-center justify-center overflow-hidden rounded-lg border dark:bg-neutral-800 bg-neutral-50 p-10 md:shadow-xl'
      ref={containerRef}
    >
