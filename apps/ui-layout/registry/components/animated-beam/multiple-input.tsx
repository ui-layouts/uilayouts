...
export default function index() {
  ...
  return (
    <div
      className='relative flex h-full w-full max-w-[32rem] mx-auto items-center justify-center overflow-hidden rounded-lg border dark:bg-neutral-800 bg-neutral-50 lg:p-10 sm:p-4 p-2 md:shadow-xl'
      ref={containerRef}
    >
