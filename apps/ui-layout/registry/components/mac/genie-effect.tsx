...
function SafariContent() {
  return (
    <div className='flex flex-col h-full'>
      <div
        className='flex items-center gap-1 px-2 py-1.5 border-b border-white/[0.06]'
      ...
      <div className='px-3 py-2 border-b border-white/[0.06]'>
        ...
        >
          ...
          <span className='text-white/75 flex-1 truncate'>https://apple.com</span>
          <span className='text-white/40'>⟳</span>
        </div>
      </div>
      <div className='px-4 pt-4'>
        ...
        >
          <span className='text-white/90 text-xl font-semibold'>Welcome to Safari</span>
        </div>
      </div>
  ...
  return (
    <div className='flex h-full'>
      <div
        ...
        style={{ background: 'rgba(255,255,255,.02)' }}
      >
        <div className='text-[9px] text-white/30 uppercase tracking-wider px-2 py-1'>Today</div>
        {[
          ['#FF536A', 'Figma'],
          ['#7B61FF', 'GitHub'],
          ['#06C2E7', 'Linear'],
      ...
      <div className='flex-1 p-4 flex flex-col'>
        ...
        >
          <div className='text-white text-sm font-semibold mb-0.5'>Design System v2</div>
          <div className='text-white/85 text-[10px]'>Edited 2 hours ago • 14 collaborators</div>
        </div>
      ...
      {cols.map((col, ci) => (
        ...
        >
          <div className='flex items-center justify-between mb-2 px-1'>
            <span className='text-[10px] font-semibold text-white/85'>{col.title}</span>
          ...
          <div className='space-y-1.5'>
            {col.cards.map((c, i) => (
              ...
              >
                <div className='text-[11px] text-neutral-800 leading-tight mb-1.5'>{c.title}</div>
                <span
    ...
    <div className='flex flex-col h-full p-3'>
      <div className='flex items-center gap-2.5 mb-3'>
        ...
        <div className='flex-1'>
          <div className='text-[11px] text-white/85 font-semibold'>Popular Shots</div>
      ...
      <div className='grid grid-cols-2 gap-2 flex-1 overflow-hidden'>
        {shots.map((s, i) => (
          <div key={i} className='rounded-lg overflow-hidden flex flex-col'>
            ...
            >
              <span className='text-white/95 text-[10px] font-semibold'>{s.label}</span>
            </div>
            <div
  ...
  return (
    ...
    >
      ...
      <div className='flex-1 px-3 py-3 space-y-1.5 text-[11px] overflow-hidden'>
        ...
        <div className='text-white/40 pl-3'>Welcome to Command Code · v0.4.2</div>
        <div className='text-white/40 pl-3'>Working in: ~/projects/genie-effect</div>
        <div className='mt-2'>
          <span className='text-emerald-400'>❯</span>{' '}
          <span className='text-white/85'>refactor to use html-to-image</span>
        </div>
        <div className='text-amber-300/85 pl-3'>Reading genie-magnified-dock.tsx...</div>
        <div className='text-white/55 pl-3'>Found offscreen canvas drawers (~280 lines)</div>
        <div className='text-emerald-400/85 pl-3'>✓ Removed offscreenDrawers</div>
        <div className='text-emerald-400/85 pl-3'>✓ Added snapshot pipeline</div>
...
function UILayoutsContent() {
  ...
  return (
    <div className='flex flex-col h-full p-3'>
      <div className='text-white/90 text-[12px] font-semibold mb-0.5'>Templates</div>
      <div className='text-white/45 text-[10px] mb-3'>Starting points for your next project</div>
      <div className='grid grid-cols-3 gap-2 flex-1'>
        {layouts.map((l, i) => (
          <div key={i} className='rounded-md p-2.5 flex flex-col' style={{ background: '#1D04FF' }}>
  ...
  return (
    <div
      ...
      style={{
        ...
        background: '#1e1e1e',
        zIndex: 40,
        boxShadow: '0 32px 80px rgba(0,0,0,.7), 0 0 0 1px rgba(255,255,255,.07)',
      }}
    >
      <div
      ...
      >
        <div className='flex items-center gap-2 z-10'>
          <Button
            onClick={onClose}
            className='w-3.5 h-3.5 grid place-items-center rounded-full border-none cursor-pointer group hover:brightness-90 transition-all bg-red-500 shadow'
          >
            <X className='w-3 h-3 text-black' />
          </Button>
          <Button
            onClick={onClose}
            className='w-3.5 h-3.5 rounded-full grid place-items-center border-none cursor-pointer hover:brightness-90 transition-all bg-yellow-500 shadow'
          >
            <Minus className='w-3 h-3 text-black' />
          </Button>
          <Button className='w-3.5 h-3.5 rounded-full bg-green-500'></Button>
        </div>
        <span
...
export default function GenieEffect() {
  ...
  const getWinPos = useCallback(
    (): Pt => ({
      x: (window.innerWidth - WIN_W) / 2,
      y: (window.innerHeight - WIN_H) / 2 - 20,
    }),
    []
  );
  ...
  }, [setupCanvas, getDockCenter, getWinPos, startAnim, clearCanvas]);
  ...
  return (
    <div className='relative w-full h-150 overflow-hidden select-none'>
      <img src='/macos.jpg' alt='macos' className='absolute inset-0 w-full h-full object-cover' />
      ...
      >
        <span className='text-white/70 text-[11px] font-semibold tracking-tight flex items-center gap-2'>
          <img src='./macicon.png' className='w-4 h-4 inline-block' /> {app?.label ?? 'Finder'}{' '}
          ...
          <TooltipProvider delayDuration={0}>
            <motion.div
              ...
              style={{
                ...
                boxShadow: '0 8px 32px rgba(0,0,0,.5),inset 0 1px 0 rgba(255,255,255,.10)',
              }}
            >
              {APPS.map((a, i) => (
                <MagnifiedDockIcon
