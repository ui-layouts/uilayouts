  ...
  return (
    <>
      <section className='relative border rounded-lg w-full'>
        ...
        ></div>
        <section className='  font-semibold 2xl:h-[450px] sm:h-[450px] h-[400px] bg-gradient-to-t dark:to-neutral-950 dark:from-neutral-950 to-[#dadada] from-[#ebebeb] flex flex-col items-center justify-center dark:text-white text-black'>
