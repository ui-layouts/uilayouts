...
export const dataArray: DocsSection[] = [
  {
    ...
    componentArray: [
      ...
      },
      {
        ...
        parentName: 'Drag Items',
        isNew: true,
      },
      {
        componentName: 'card-globe',
        iframelink: 'card-globe',
        parentlink: 'globe',
        parentName: 'Globe',
      },
      {
        componentName: 'card-globe2',
    ...
    componentArray: [
      {
        ...
        parentName: 'Img Ripple Effect',
      },
      {
        componentName: 'r3f-blob',
        iframelink: 'r3f-blob',
        parentlink: 'r3f-blob',
        parentName: 'R3F Blob',
      },
      {
        componentName: 'mesh-shadergradient',
        iframelink: 'mesh-shadergradient',
        parentlink: 'mesh-gradients',
        parentName: 'Mesh Gradients',
      },
      {
        componentName: 'lemon-mesh-gradients',
        iframelink: 'mesh-gradient-background',
        parentlink: 'mesh-gradients',
        parentName: 'Mesh Gradients',
      },
      {
        componentName: 'yellow-mesh-gradients',
        iframelink: 'mesh-gradient-background3',
        parentlink: 'mesh-gradients',
        parentName: 'Mesh Gradients',
      },
      {
        componentName: 'blue-mesh-gradients',
  ...
  },
  {
    ...
    componentArray: [
      ...
      {
        componentName: 'pass-strengthindicator',
      ...
      {
        componentName: 'pass-strengthindicator2',
      ...
      {
        componentName: 'pass-strengthindicator3',
      ...
      {
        componentName: 'pass-strengthindicator4',
      ...
      {
        componentName: 'confirm-pass-check',
      ...
      },
      {
        ...
        parentName: 'Tags Input',
      },
      {
        componentName: 'tagsedit-false',
      ...
      {
        componentName: 'imgpreview-dropzone',
      ...
      {
        componentName: 'chat-form-dropzone',
  ...
  },
  {
    ...
    componentArray: [
      ...
      {
        componentName: 'sparkles-section',
        iframelink: 'sparkles-section',
        parentlink: 'sparkles',
        parentName: 'Sparkles',
      },
      {
        componentName: 'sparkles-branding',
        iframelink: 'sparkles-branding',
        parentlink: 'sparkles',
        parentName: 'Sparkles',
      },
      {
        componentName: 'sparkles-title',
        iframelink: 'sparkles-title',
        parentlink: 'sparkles-title',
        parentName: 'Sparkles Title',
      },
      {
        componentName: 'sparkles-title2',
      ...
      {
        componentName: 'sparkles-title3',
        iframelink: 'sparkles-title3',
        parentlink: 'sparkles-title',
        parentName: 'Sparkles Title',
      },
      {
        componentName: 'sparkles-title4',
  ...
  },
  {
    ...
    componentArray: [
      ...
      },
      {
        ...
        parentlink: 'uilayouts-github-button',
        parentName: 'Github Button',
      },
      {
      ...
      },
      {
        ...
        parentName: 'Motion Number',
      },
      {
        componentName: 'number-flow-trading',
      ...
      {
        componentName: 'image-mousetrail-without-component',
  ...
  },
  {
    ...
    componentArray: [
      ...
      },
      {
        ...
        parentName: 'Media Modal',
      },
      {
        componentName: 'imagemodalsl',
      ...
      },
      {
        ...
        filesrc: 'components/modal/dialog-card/index.tsx',
        iframeSrc: 'live-components/dialog-card-linear',
        parentlink: 'linear-card',
        parentName: 'Linear Card',
      },
      {
  ...
  },
  {
    ...
    componentArray: [
      ...
      },
      {
        ...
        parentName: 'stacking-card',
      },
      {
        componentName: 'css-card-stacking',
        iframelink: 'css-stacking-details-card',
        parentlink: 'stacking-card',
        parentName: 'stacking-card',
      },
      {
        componentName: 'css-image-stacking',
  ...
  },
  {
    ...
    componentArray: [
      ...
      {
        componentName: 'watersplash-clippath',
      ...
      },
      {
        ...
        parentName: 'Image Masking',
      },
      {
        componentName: 'animal-imagemasking',
      ...
      {
        componentName: 'watersplash-imagemasking',
      ...
      {
        componentName: 'center-imagemasking',
      ...
      {
        componentName: 'fixedbg-imagemasking',
      ...
      {
        componentName: 'hexagon-videomasking',
      ...
      {
        componentName: 'hexagon2-videomasking',
