export const metadata = {
  ...
  title: "Image Ripple Effect Component",
  description: "An animated image ripple effect component built with React-Three-Fiber, featuring stunning 3D ripple animations and WebGL-powered visual effects. Creates dynamic water-like ripples across images with smooth Three.js animations for immersive web experiences.",
  keywords: [
    "Image ripple effect",
    "React-Three-Fiber ripple",
    "Three.js image effects",
    "Animated ripple component",
    "3D ripple animation",
    "WebGL image ripples",
    "React Three Fiber",
    "Three.js ripple effect",
    "3D image animation",
    "Ripple animation component",
    "Water ripple effect",
    "Interactive ripple effect",
    "3D image effects",
    "WebGL ripple animation",
    "Image wave effect",
    "Dynamic ripple component",
    "3D graphics ripple",
    "React 3D effects",
    "Three.js animations",
    "Image distortion effects",
    "Ripple shader effects",
    "3D visual effects",
    "Interactive 3D ripples",
    "Modern ripple animation",
    "Immersive image effects",
  ...
  openGraph: {
    title: "Image Ripple Effect Component | UI Layouts",
    description: "An animated image ripple effect component built with React-Three-Fiber, featuring stunning 3D ripple animations and WebGL-powered visual effects for immersive experiences.",
    url: "https://ui-layouts.com/components/image-ripple-effect",
    images: [
      {
  ...
  twitter: {
    ...
    description: "Animated image ripple effect built with React-Three-Fiber, featuring 3D ripple animations and WebGL-powered visual effects.",
    creator: "@naymur_dev",
  },
  robots: {
    index: true,
