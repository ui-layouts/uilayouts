export const metadata = {
  ...
  description: "Apple Vision Pro-inspired blur vignette effect for creating stunning visual overlays. Apply beautiful blur effects to images, videos, cards, and UI elements. Features customizable intensity, smooth transitions, and modern glassmorphism design aesthetics.",
  keywords: [
    "Blur vignette effect",
    "Apple Vision Pro blur",
  ...
  openGraph: {
    ...
    description: "Apple Vision Pro-inspired blur vignette effect for creating stunning visual overlays on images, videos, and cards with modern glassmorphism design.",
    siteName: "UI Layouts",
  ...
  twitter: {
    ...
    title: "Blur Vignette Effect | UI Layouts",
    description: "Apple Vision Pro-inspired blur vignette effect for stunning visual overlays on images, videos, and cards.",
