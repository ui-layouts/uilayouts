...
<TabsList className='border-b w-full bg-muted justify-start h-12 mt-4'>
  <TabsTrigger value='preview' className="data-[state=active]:bg-card gap-1 data-[state=active]:border">Preview</TabsTrigger>
  <TabsTrigger value='code' className="data-[state=active]:bg-card gap-1 data-[state=active]:border">Code</TabsTrigger>
</TabsList>
  <TabsContent value="preview"  className="p-4 dark:bg-black bg-white border">
   <CodeTabsMdx>
      ```bash
...
<TabsList className='border-b w-full bg-muted justify-start h-12 mt-4'>
  <TabsTrigger value='index' className="data-[state=active]:bg-card gap-1 data-[state=active]:border">index</TabsTrigger>
  <TabsTrigger value='shiki' className="data-[state=active]:bg-card gap-1 data-[state=active]:border">shiki-highlighter</TabsTrigger>
</TabsList>
...
export default async function CodeTabsMdx({ children }: any) {
  ...
  return (
    <Tabs
      ...
      className='rounded-xl bg-muted dark:border-neutral-800 backdrop-blur-md border relative p-1 my-5'
    >
...
This components specificly design for mdx files to highlight code blocks with shiki. so you just have copy the code from ☝ and start using it in your mdx files.