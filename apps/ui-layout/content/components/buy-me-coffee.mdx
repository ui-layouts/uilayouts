export const metadata = {
  ...
  openGraph: {
    ...
    description: "A fun and creative sponsorship component inspired by 'Buy Me a Coffee' with a twist! Perfect for creators looking to attract sponsors with a playful approach.",
  ...
  twitter: {
    ...
    description: "A fun sponsorship component with a creative twist on 'Buy Me a Coffee' - perfect for attracting supporters and sponsors!",
    creator: "@naymur_dev",
  },
  robots: {
    index: true,
