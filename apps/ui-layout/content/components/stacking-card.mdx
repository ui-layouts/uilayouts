export const metadata = {
  ...
  title: "Stacking Card",
  description:
    "An animated stacking card effect built with React and Framer Motion. Cards layer and animate with smooth transitions, creating an engaging and modern interactive UI experience.",
  keywords: [
    "Stacking card animation",
    "Framer Motion cards",
    "React card animation",
    "Card stacking effect",
    "Animated card transitions",
    "Layered card UI",
    "React stacking cards",
    "Interactive card animation",
    "Framer Motion stacking effect",
    "Overlapping cards React",
    "Smooth card transitions",
    "React motion cards",
    "Animated layered UI",
    "Card scroll animation",
    "Modern card design React",
    "Framer Motion UI component",
    "Interactive stacking cards",
    "Card animation effect",
    "React animated card layout",
    "Engaging UI card animation",
  ],
  authors: [{ name: "Naymur Rahman", url: "https://twitter.com/naymur_dev" }],
  creator: "@naymur_dev",
  publisher: "UI Layouts",
  openGraph: {
    title: "Stacking Card | UI Layouts",
    description:
      "An animated stacking card component for React using Framer Motion. Smoothly layered transitions create a visually dynamic and interactive UI.",
    url: "https://ui-layouts.com/components/stacking-card",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Stacking Card | UI Layouts",
    description:
      "Animated stacking card effect built with React and Framer Motion. Smooth transitions and layered cards for a modern UI experience.",
