export const metadata = {
  ...
  description: "Animated mesh gradients for developers. Features customizable colors, speed controls, and interactive animations.",
  keywords: [
  ...
  openGraph: {
    title: "Mesh Gradients Component | UI Layouts",
    description: "Animated mesh gradients for developers. Features customizable colors, speed controls, and interactive animations.",
    images: [
      {
    ...
    siteName: "UI Layouts",
    locale: "en_US",
    url: "https://ui-layouts.com/components/mesh-gradients",
    type: "website",
  },
  twitter: {
    ...
    description: "Animated mesh gradients for developers. Features customizable colors and interactive animations.",
    creator: "@naymur_dev",
  },
  robots: {
    index: true,
...
<IframeComponentPrieview name='mesh-gradient-background3'  hasReTrigger responsive >
...
<IframeComponentPrieview name='mesh-gradient-background2'  hasReTrigger responsive >
...
<IframeComponentPrieview name='mesh-gradient-background'  hasReTrigger responsive >
