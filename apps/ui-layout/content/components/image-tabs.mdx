export const metadata = {
  ...
  title: "Image Tabs",
  description: "An animated tabs component with image navigation and FAQ-style content switching, where users navigate through images and content using smooth animated tabs. Features dynamic tab transitions, image galleries, and interactive content organization.",
  keywords: [
    "Animated tabs component",
    "Image tabs navigation",
    ...
    "Tailwind animated tabs"
  ],
  authors: [{ name: "Naymur Rahman", url: "https://twitter.com/naymur_dev" }],
  creator: "@naymur_dev",
  publisher: "UI Layouts",
  openGraph: {
    title: "Image Tabs | UI Layouts",
    description: "An animated tabs component with image navigation and smooth transitions, where users navigate through images and content using interactive animated tabs.",
    url: "https://ui-layouts.com/components/image-tabs",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Animated Tabs Component | UI Layouts",
    images: ['https://ui-layouts.com/component-og.jpg'],
    description: "Animated tabs with image navigation and smooth transitions for interactive content switching and modern tab experiences.",
    creator: "@naymur_dev",
  },
  robots: {
    index: true,
