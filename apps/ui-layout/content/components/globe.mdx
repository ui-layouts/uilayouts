...
<IframeComponentPrieview name='card-globe-default' hasReTrigger isFitheight responsive >
...
<IframeComponentPrieview name='card-globe-white' hasReTrigger isFitheight responsive >
