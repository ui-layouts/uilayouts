export const metadata = {
  ...
  title: "Animated Globe Component",
...
<IframeComponentPrieview name='card-globe' hasReTrigger isFitheight responsive >
...
<IframeComponentPrieview name='card-globe2' hasReTrigger isFitheight responsive >
