export const metadata = {
  ...
  title: "R3F Blob",
  description:
    "A 3D animated blob built with React Three Fiber (R3F). Features smooth, organic animations ideal for modern hero sections, interactive backgrounds, and creative UI effects.",
  keywords: [
    "R3F blob",
    ...
    "Three.js blob effect",
    "react-three-fiber animation",
    "3D UI blob",
    "React Three Fiber shapes",
    "Blob mesh animation",
    "3D interactive blob",
    "React motion 3D",
    "Three.js blob geometry",
    "R3F animated mesh",
    "3D background blob",
    "Hero section 3D blob",
    "React abstract blob",
    "WebGL blob React",
    "Modern 3D UI effect",
  ],
  ...
  openGraph: {
    title: "R3F Blob | UI Layouts",
    description:
      "A 3D animated blob component using React Three Fiber (R3F). Perfect for hero sections, interactive backgrounds, and dynamic UI designs.",
    url: "https://ui-layouts.com/components/r3f-blob",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "Animated 3D blob built with React Three Fiber (R3F). Smooth organic motion for modern UI backgrounds and hero sections.",
    creator: "@naymur_dev",
  },
  robots: {
    index: true,
...
<IframeComponentPrieview name='r3f-blob'  hasReTrigger responsive>
