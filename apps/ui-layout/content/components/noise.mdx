...
<main className='relative '>
  ...
  ></div>
  <section className='  font-semibold 2xl::h-[600px] sm:h-[500px] h-[450px] bg-linear-to-t dark:to-gray-800 dark:from-gray-950 to-[#dadada] from-[#ebebeb] flex flex-col items-center justify-center dark:text-white text-black'>
