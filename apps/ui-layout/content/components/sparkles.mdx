export const metadata = {
  ...
  keywords: [
    "Sparkles effect React",
    "Animated sparkles UI",
    "React particle effect",
    "Sparkles around div",
    "Sparkling section effect",
    "Glitter effect React",
    "Shiny UI animation",
    "Sparkle overlay React",
    "Dynamic sparkles animation",
    "tsparticles sparkles",
    "React background sparkles",
    "Particle sparkle effect",
    "Glittering section highlight",
    "React glowing particles",
    "Animated highlight effect",
    "Sparkling border React",
    "Modern UI sparkles",
    "React div sparkle effect",
  ...
  openGraph: {
    title: "Sparkles | UI Layouts",
    description:
      "An animated sparkles effect for React that wraps around any div or section. Perfect for adding dynamic glowing accents to UI components.",
    url: "https://ui-layouts.com/components/sparkles",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "Animated sparkles effect for React that can surround any div or section. Adds glittering highlights for modern UIs.",
    creator: "@naymur_dev",
  },
  robots: {
    index: true,
  ...
  return (
    <>
      <div className='h-screen w-screen overflow-hidden bg-black'>
        ...
        <div className='relative -mt-32 h-96 w-screen overflow-hidden mask-[radial-gradient(50%_50%,white,transparent)] before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom_center,#369eff,transparent_80%)] before:opacity-100 after:absolute after:-left-1/2 after:top-1/2 after:aspect-[1/0.7] after:w-[200%] after:rounded-[100%] after:border-t after:border-[#7876c566] after:bg-zinc-900'>
