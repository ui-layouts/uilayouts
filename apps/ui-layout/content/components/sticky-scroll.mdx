export const metadata = {
  ...
  openGraph: {
    title: "Sticky Scroll | UI Layouts",
    description:
      "Sticky scroll component for React with Tailwind CSS. Keeps elements fixed within their container while scrolling, ideal for modern interactive layouts.",
    url: "https://ui-layouts.com/components/sticky-scroll",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "A Tailwind CSS sticky scroll effect for React. Fix elements inside their container during scroll for engaging layouts and storytelling UIs.",
    creator: "@naymur_dev",
  },
  robots: {
    index: true,
