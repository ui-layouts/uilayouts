  ...
  return (
    <>
      <div className='flex xl:flex-col xl:flex-nowrap flex-wrap  mx-auto lg:gap-5 gap-2 items-center justify-center lg:py-10 py-2 2xl:px-0 px-2'>
        ...
        <button className='group relative inline-flex h-12 2xl:w-36 xl:w-full w-36 text-sm items-center justify-center overflow-hidden rounded-md   bg-linear-to-r dark:from-[#070e41] dark:to-[#263381] from-[#f6f7ff] to-[#f5f6ff] dark:border-[rgb(76_100_255)] border-2 border-[#263381] bg-transparent px-6 font-medium dark:text-white text-black transition-all duration-100 dark:[box-shadow:5px_5px_rgb(76_100_255)] [box-shadow:5px_5px_rgb(38_51_129)] active:translate-x-[3px] active:translate-y-[3px] active:[box-shadow:0px_0px_rgb(38_51_129)] dark:active:[box-shadow:0px_0px_rgb(76_100_255)]'>
          Contact me
        </button>
        <button className=' inline-flex h-12 animate-background-shine items-center justify-center rounded-md  border-2 dark:border-[#656fe2] border-[#c0c6fc] dark:bg-[linear-gradient(110deg,#1e2a78,45%,#3749be,55%,#1e2a78)] bg-[linear-gradient(110deg,#3d5af1,45%,#5471ff,55%,#3d5af1)] bg-size-[200%_100%] dark:hover:border-white w-36 font-medium text-white dark:text-white transition-colors focus:outline-hidden focus:ring-2 dark:focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50'>
          Click Me
        </button>
        <button className='group relative cursor-pointer h-12 2xl:w-36 xl:w-full w-36 border bg-white rounded-full overflow-hidden text-black text-center font-semibold'>
        ...
        <button className='relative inline-flex h-12 2xl:w-36 xl:w-full w-36 overflow-hidden rounded-full p-[2px] focus:outline-hidden focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50'>
