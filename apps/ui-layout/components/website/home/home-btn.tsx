  ...
  return (
    <>
      <div className='flex xl:flex-col xl:flex-nowrap flex-wrap  mx-auto lg:gap-5 gap-2 items-center justify-center lg:py-10 py-2 2xl:px-0 px-2'>
        ...
        <button className='relative inline-flex h-12 2xl:w-36 xl:w-full w-36 overflow-hidden rounded-full p-[2px] focus:outline-hidden focus:ring-2 focus:ring-neutral-400 focus:ring-offset-2 focus:ring-offset-neutral-50'>
