...
const FileSvgDraw = () => {
  return (
    <>
      ...
      <p className='mb-1 md:text-sm text-xs  text-primary'>
...
const HomeFileUpload = () => {
  ...
  return (
    ...
    >
      <FileInput className='outline-dashed bg-card outline-2 outline-primary/40'>
        ...
        {files?.map((file, i) => (
          ...
          >
            <Image
              ...
              height={80}
              width={80}
              className='2xl:size-20 size-16 rounded-md object-cover bg-primary'
            />
          </FileUploaderItem>
        ))}
      </FileUploaderContent>
