  ...
  return (
    <>
      <section className='xl:px-10'>
        <div className='container mx-auto border-x dark:border-neutral-700 pt-36'>
          ...
          {/* <Footer /> */}
          <HomeFooter
            className='mt-20 bg-linear-to-t dark:from-neutral-800 from-neutral-200 to-transparent'
