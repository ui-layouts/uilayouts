        ...
        <section className='p'>
          ...
          <article className='w-fit mx-auto max-w-5xl text-center space-y-4 p-10'>
            <h1 className='font-manrope font-medium xl:text-7xl lg:text-6xl md:text-5xl sm:text-4xl text-3xl'>
              <span>
                Build & Ship{' '}
                <span className='bg-linear-to-tr from-primary via-primary/60 to-primary font-bold bg-clip-text text-transparent'>
                  faster
                </span>{' '}
                With,
              </span>
              ...
              <span>
                {' '}
                Production-ready{' '}
                <span className='bg-linear-to-br from-primary via-primary/50 to-primary font-bold bg-clip-text text-transparent'>
                  blocks.
                </span>{' '}
              </span>
            </h1>
            ...
            <div className='flex gap-2 items-center w-fit mx-auto'>
              <a
                ...
                target='_blank'
                className='bg-secondary p-2 border h-14 w-14 grid place-items-center'
                rel='noreferrer noopener'
              >
                <svg
                  width='569'
                  className='w-7 h-7 fill-primary stroke-primary'
                  height='512'
                  viewBox='0 0 569 512'
                  fill='none'
