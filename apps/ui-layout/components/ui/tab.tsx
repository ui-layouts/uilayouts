        ...
        {activeTab === value && (
          <>
            <motion.div
              ...
              className='absolute w-full h-full left-0 top-0 bg-card dark:bg-secondary rounded-md z-1'
            />
            ...
            {wobbly && (
              <>
                <motion.div
                  ...
                  layoutId={defaultValue}
                  className='absolute w-full h-full left-0 top-0 bg-card rounded-md z-1 tab-shadow'
                />
                <motion.div
                  transition={{
                    layout: {
