      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              'flex w-full p-1 rounded-md border min-h-10 h-auto items-center justify-between dark:bg-neutral-800 bg-neutral-50 hover:dark:bg-neutral-800 bg-neutral-50',
              className
            )}
          >
