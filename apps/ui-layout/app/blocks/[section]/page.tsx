            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-3 gap-6 py-16'>
              {sectionData.blocks?.map((block) => (
                <Link
                  ...
                  className='relative group no-underline dark:bg-neutral-950 bg-neutral-200 p-4 rounded-lg border dark:border-neutral-800 border-neutral-300'
                >
                  <Image
                    src={block.imgSrc}
                    alt={block.name}
                  ...
                  />
                  <h3 className='mt-2 text-lg font-medium absolute bottom-2 left-2'>
                    {block.name}
                  </h3>
