...
export const feature_bentoDesign = defineDesignSystem({
  ...
  effects: [
    {
      name: 'Electric bento atmosphere',
      recipe:
        'Vary card spans and surface colors; layer blue gradient blobs with 2xl/3xl blur, photographic overlays, glass chips, and an icon that rotates 45° while the card subtly scales.',
      usage: 'giving each capability a distinct miniature world inside one grid',
    },
    {
  ...
  extensionRules: [
    'Carry the **Electric bento atmosphere** into at least one meaningful focal area; reproduce its layer recipe rather than substituting a generic gradient.',
