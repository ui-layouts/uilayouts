...
export const chat_interface_testimonialDesign = defineDesignSystem({
  name: 'Chat Interface',
  personality:
  ...
  effects: [
    {
      name: 'Conversation over sunrise grid',
      recipe:
        'Place chat bubbles on a fine light grid that dissolves into a yellow radial horizon; use pastel avatar bubbles, green presence, and staged scale/opacity message arrivals.',
      usage: 'turning testimonials into an unfolding support conversation',
    },
    {
  ...
  extensionRules: [
    'Carry the **Conversation over sunrise grid** into at least one meaningful focal area; reproduce its layer recipe rather than substituting a generic gradient.',
