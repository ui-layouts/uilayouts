...
export const feature_highlightsDesign = defineDesignSystem({
  ...
  effects: [
    {
      name: 'Black spotlight strip',
      recipe:
        'Keep the surface nearly black, typography white/slate, and use pink as the only high-energy accent; crop product visuals aggressively and scale the active highlight rather than decorating every item.',
      usage: 'directing attention through strong contrast and one accent',
    },
    {
  ...
  extensionRules: [
    'Carry the **Black spotlight strip** into at least one meaningful focal area; reproduce its layer recipe rather than substituting a generic gradient.',
